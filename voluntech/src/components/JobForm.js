...
const JobForm = ({chosenCharity}) => {
    ...
    return ( 
        <form onSubmit={handleFormSubmit} className="job-form name-card shadow-lg rounded-xl border-2 px-5 py-5 border-black w-96 overflow-y-auto" style={{height: '100%', width: '100%'}}>
